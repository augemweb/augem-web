    ...
    <div className="min-h-screen bg-white text-gray-900">
      ...
      <header className="sticky top-0 z-40 backdrop-blur bg-white/70 border-b">
        <Section className="flex items-center justify-between py-3">
          ...
          <nav className="hidden md:flex items-center gap-6 text-sm">
            ...
            <Link href="/proceso" className="hover:underline">
              Proceso
            </Link>
            <Link href="/credenciales" className="hover:underline">
              Credenciales
            </Link>
      ...
      <Section id="inicio" className="py-14 md:py-20">
        ...
        >
          ...
          <div
            className="inline-flex items-center gap-2 text-xs px-3 py-1 rounded-full mb-4 justify-center
            bg-[oklch(0.23_0.05_270/_0.10)] text-[oklch(0.23_0.05_270)]"
          >
            <ShieldCheck className="w-4 h-4" /> Informes periciales con validez
            legal
          </div>
          ...
          <p className="mt-4 text-lg text-gray-700 max-w-3xl mx-auto">
            Servicio profesional para <strong>particulares</strong>,{" "}
            <strong>aseguradoras</strong> y{" "}
            <strong> despachos de abogados</strong>. Valoración objetiva y{" "}
            <strong>metodología gemológica</strong>. Informes{" "}
            <strong>impresos y firmados</strong> con su <strong>PDF</strong>{" "}
            correspondiente.
          </p>
          ...
          <p className="mt-3 text-gray-700 max-w-3xl mx-auto">
            ...
            y conoce el{" "}
            <Link href="/proceso" className="underline">
              proceso de trabajo
            </Link>
            . Formación IGE y{" "}
            <Link href="/credenciales" className="underline">
              acreditación A.E.T.A. nº 230
            </Link>
            .
          </p>
          ...
          <ul className="mt-6 grid gap-2 text-sm text-gray-600 justify-center">
            <li className="flex items-center gap-2 justify-center">
              <Sparkles className="w-4 h-4 text-[oklch(0.23_0.05_270)]" /> Informe
              impreso + PDF
            </li>
            <li className="flex items-center gap-2 justify-center">
              <Sparkles className="w-4 h-4 text-[oklch(0.23_0.05_270)]" />{" "}
              Presupuesto cerrado y transparente
            </li>
            <li className="flex items-center gap-2 justify-center">
              <Sparkles className="w-4 h-4 text-[oklch(0.23_0.05_270)]" /> Custodia
              segura y opción de desplazamiento
            </li>
          </ul>
        </motion.div>
      </Section>
      ...
      <Section className="pt-2">
        <div className="grid md:grid-cols-3 gap-4 text-sm text-gray-700 text-center">
          <div className="rounded-xl border p-3">
            Acreditación <strong>A.E.T.A. nº 230</strong>
          </div>
          <div className="rounded-xl border p-3">
            Formación <strong>IGE</strong> (gemología y tasación)
          </div>
          <div className="rounded-xl border p-3">
            Informe <strong>impreso + PDF</strong> con validez legal
          </div>
        </div>
      </Section>
          ...
          <div className="grid md:grid-cols-3 gap-6 mt-8 text-sm">
            <div className="p-5 border rounded-2xl">
              ...
              <p className="text-gray-700 mt-1">
                Formación IGE y acreditación A.E.T.A. nº 230. Metodología y
                criterios de valoración profesionales.
              </p>
            </div>
            <div className="p-5 border rounded-2xl">
              <h3 className="font-semibold">Validez legal</h3>
              <p className="text-gray-700 mt-1">
                Informes periciales claros, defendibles y aceptados por
                aseguradoras y despachos.
              </p>
            </div>
            <div className="p-5 border rounded-2xl">
              <h3 className="font-semibold">Seguridad y confianza</h3>
              <p className="text-gray-700 mt-1">
                Custodia en caja fuerte, cámaras y alarma. Desplazamiento a
                domicilio/empresa si lo necesitas.
              </p>
            </div>
          </div>
        </motion.div>
      ...
      <Section id="servicios" className="py-16 md:py-24">
        ...
        >
          ...
          <p className="mt-3 text-gray-700 max-w-3xl">
            Tasación <strong>objetiva y con validez legal</strong> para{" "}
            <strong>particulares</strong>, <strong>aseguradoras</strong> y{" "}
            <strong>despachos de abogados</strong>. Trabajo con{" "}
            <strong>metodología gemológica</strong> y resultados documentados
            (fotografías, mediciones y conclusiones) para su uso en{" "}
            <strong>siniestros</strong>, <strong>herencias</strong> y{" "}
          ...
          <div className="grid md:grid-cols-3 gap-6 mt-8">
            {[
              ...
              {
                title: "Herencias y reparto",
                desc: "Listados y valores de mercado para particiones justas.",
              },
              {
                title: "Compra/venta",
                desc: "Opinión independiente antes de comprar o vender una pieza.",
              },
              {
                title: "Identificación de metales",
                desc: "Ensayos no destructivos para confirmar quilataje.",
              },
              {
      ...
      <Section id="proceso" className="py-16 md:py-24">
        ...
        >
          ...
          <p className="mt-3 text-gray-700 max-w-3xl">
            Un método en <strong>4 pasos</strong> para que sepas en todo momento
            el estado de tu tasación: contacto y{" "}
            <strong>presupuesto cerrado</strong>, recepción en laboratorio o{" "}
            <strong>desplazamiento</strong>, <strong>análisis gemológico</strong>{" "}
            y <strong>entrega de informe impreso + PDF</strong> con validez legal.
          </p>
          ...
          <div className="grid md:grid-cols-4 gap-6 mt-8 text-sm">
            {[
              ...
              <div key={p.step} className="relative p-5 border rounded-2xl">
                <div className="absolute -top-3 left-5 bg-black text-white text-xs px-2 py-0.5 rounded-full">
                  Paso {p.step}
                </div>
      ...
      <Section id="credenciales" className="py-16 md:py-24">
        ...
        >
          ...
          <p className="mt-3 text-gray-700 max-w-3xl">
            Tradición joyera/relojera de <strong>tres generaciones</strong>,
            formación en el <strong>Instituto Gemológico Español (IGE)</strong> y
            acreditación como <strong>socio A.E.T.A. nº 230</strong>. Informes
            claros, objetivos y defendibles ante <strong>aseguradoras</strong> y{" "}
          ...
          <div className="grid md:grid-cols-3 gap-6 mt-8">
            <Card className="rounded-2xl">
              ...
              <CardContent className="text-sm text-gray-600 space-y-2">
                <p>
                  Instituto Gemológico Español (IGE) – Gemología, diamante,
                  perlas, piedras de color y tasación
                </p>
                <p>
                  Asociación Española de Tasadores de Alhajas (AETA) – Tasación
                  profesional
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="rounded-2xl">
              ...
              <CardContent className="text-sm text-gray-600">
                4 años certificando oro 18k, autenticando diamantes y graduando
                gemas en empresas privadas. Informes y certificados con validez
                legal a nivel particular.
              </CardContent>
            </Card>
            ...
            <Card className="rounded-2xl">
              ...
              <CardContent className="text-sm text-gray-600">
                Servicio principal en Málaga y provincia. Desplazamientos a nivel
                nacional para proyectos que lo justifiquen.
              </CardContent>
            </Card>
          </div>
        </motion.div>
      ...
      <Section className="py-16 md:py-24">
        ...
        <div className="mt-8 grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
          {[
            ...
            <div
              key={item.q}
              className="p-5 border rounded-2xl shadow-sm bg-gray-50"
            >
        ...
        <Card className="rounded-2xl border-dashed bg-[oklch(0.97_0.01_270)]">
          <CardContent className="py-10 text-center">
            <h3 className="text-xl md:text-2xl font-semibold">
              ¿Necesitas una tasación o informe pericial?
            </h3>
            <p className="mt-2 text-gray-700 max-w-2xl mx-auto">
              Presupuesto cerrado y <strong>entrega impresa + PDF</strong>.
            ...
            <div className="mt-4 flex items-center justify-center gap-6 text-sm text-gray-700">
              ...
              <span className="inline-flex items-center gap-1">
                <MapPin className="w-4 h-4" /> Málaga
              </span>
              <span className="inline-flex items-center gap-1">
                <FileText className="w-4 h-4" /> Informe en 24–72h*
              </span>
            </div>

            <p className="text-xs text-gray-500 mt-2">
              *Plazo orientativo según piezas y volumen.
            </p>
          </CardContent>
        </Card>
      </Section>
      ...
      <footer className="border-t mt-16">
        <Section className="py-8 text-sm text-gray-600 grid md:grid-cols-3 gap-6">
          <div className="flex flex-col items-center text-center">
            ...
            <p className="text-gray-700">NIF: 76428747T · Socio A.E.T.A. nº 230</p>
          ...
          <div className="space-y-1 text-center md:text-left">
            ...
            <Link href="/proceso" className="block hover:underline">
              Proceso
            </Link>
            <Link href="/credenciales" className="block hover:underline">
              Credenciales
            </Link>
